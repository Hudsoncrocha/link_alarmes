...
export default function HomeBackup() {
  ...
  return (
    <div className="flex flex-col w-full bg-slate-950 text-slate-100 overflow-x-hidden font-sans">
      ...
      {/* 3. DESCRIÇÃO RESUMIDA DE SOLUÇÕES (OS 4 PILARES) */}
      <section className="py-20 bg-slate-900/40 border-b border-slate-900">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            {/* Pilar 1: CFTV */}
            <div className="card-tech flex flex-col justify-between h-full">
              <div>
                <div className="h-12 w-12 rounded-lg bg-blue-950 border border-blue-800 flex items-center justify-center text-cyan-400 mb-6">
                  {/* Camera SVG */}
                  <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                    <path strokeLinecap="round" strokeLinejoin="round" d="M15 10l4.553-2.276A1 1 0 0121 8.618v6.764a1 1 0 01-1.447.894L15 14M5 18h8a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z" />
                  </svg>
                </div>
                <h3 className="text-xl font-bold text-white mb-3">Câmeras Inteligentes com Inteligência Artificial</h3>
                <p className="text-slate-400 text-sm leading-relaxed mb-6">
                  Vá muito além da simples gravação de imagens. Nossos sistemas de CFTV contam com inteligência artificial para detecção de humanos e veículos, reduzindo falsos alarmes em até 90%. Saiba o que está acontecendo acessando pelo celular em tempo real. Veja quem está prestando serviço em sua casa, acompanhe a produtividade do seu time, tire dúvidas sobre mal-entendidos com clientes e funcionários.
                </p>
              </div>
              <Link href="/lps/cameras" className="btn-neon-outline text-xs w-full py-2.5 flex items-center justify-center gap-1.5">
                Conhecer Solução de CFTV
            ...
            <div className="card-tech flex flex-col justify-between h-full">
              <div>
                ...
                <h3 className="text-xl font-bold text-white mb-3">Alarmes e Sensores de Presença Conectados</h3>
                <p className="text-slate-400 text-sm leading-relaxed mb-6">
                  Sistemas de intrusão inteligentes com sensores de presença imunes a animais de estimação. Monitoramento ativo de ponta a ponta com comunicação redundante (Wi-Fi e GPRS/4G) para que o sistema continue funcionando mesmo se houver queda de energia ou corte intencional de fiação por criminosos. Seu alarme disparando nos primeiros centímetros de invasão. Aviso imediato à polícia.
                </p>
              </div>
              <Link href="/lps/residencial" className="btn-neon-outline text-xs w-full py-2.5 flex items-center justify-center gap-1.5">
                Solicitar Projeto de Alarmes
                <svg className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                  <path strokeLinecap="round" strokeLinejoin="round" d="M9 5l7 7-7 7" />
                </svg>
              </Link>
            ...
            <div className="card-tech flex flex-col justify-between h-full">
              <div>
                <div className="h-12 w-12 rounded-lg bg-blue-950 border border-blue-800 flex items-center justify-center text-cyan-400 mb-6">
                  {/* Fingerprint SVG */}
                  <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                    <path strokeLinecap="round" strokeLinejoin="round" d="M12 11c0 3.517-1.009 6.799-2.753 9.571m-3.44-2.04l.054-.09A13.916 13.916 0 009 11a5 5 0 00-10 0c0 1.905.586 3.67 1.586 5.13M18 11a7 7 0 00-11.54-5.347M8 11.5a4.5 4.5 0 001.242 3.024" />
                  </svg>
                </div>
                <h3 className="text-xl font-bold text-white mb-3">Controle de Acesso Biométrico e Facial</h3>
                <p className="text-slate-400 text-sm leading-relaxed mb-6">
                  Monitore e gerencie com precisão cirúrgica o fluxo de colaboradores, visitantes e veículos. Implementamos fechaduras digitais e eletromagnéticas, reconhecimento biométrico e facial (mesmo sob uso de máscaras ou óculos) e leitores de placas (LPR) para portarias comerciais, condomínios e indústrias.
                </p>
              </div>
              <Link href="/lps/controle-acesso" className="btn-neon-outline text-xs w-full py-2.5 flex items-center justify-center gap-1.5">
                Blindar Controle de Acesso
                <svg className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                  <path strokeLinecap="round" strokeLinejoin="round" d="M9 5l7 7-7 7" />
                </svg>
              </Link>
            ...
            <div className="card-tech flex flex-col justify-between h-full">
              <div>
                <div className="h-12 w-12 rounded-lg bg-blue-950 border border-blue-800 flex items-center justify-center text-cyan-400 mb-6">
                  {/* Network Wifi SVG */}
                  <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                    <path strokeLinecap="round" strokeLinejoin="round" d="M19 11a7.5 7.5 0 010 10m-2.236-8.944a5 5 0 010 7.888m-2.237-6.832a2.5 2.5 0 010 3.776M12 18H12.01" />
                  </svg>
                </div>
                <h3 className="text-xl font-bold text-white mb-3">Cabeamento Estruturado e Wi-Fi 6 Corporativo</h3>
                <p className="text-slate-400 text-sm leading-relaxed mb-6">
                  Elimine quedas de internet, sinal de Wi-Fi ruim e cabos soltos pelos cantos. Projetamos e executamos infraestruturas de cabeamento estruturado e Wi-Fi 6 corporativo com redes isoladas e seguras, garantindo velocidade contínua para o bom desempenho da sua equipe.
                </p>
              </div>
              <Link href="/lps/redes-wifi" className="btn-neon-outline text-xs w-full py-2.5 flex items-center justify-center gap-1.5">
                Otimizar Conectividade Corporativa
                <svg className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                  <path strokeLinecap="round" strokeLinejoin="round" d="M9 5l7 7-7 7" />
                </svg>
              </Link>
      ...
      <section className="relative py-20 md:py-28 border-b border-slate-900 bg-[radial-gradient(ellipse_at_bottom,_var(--tw-gradient-stops))] from-slate-900 via-slate-950 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 text-center flex flex-col items-center">
          ...
          <p className="mt-6 text-base text-slate-400 md:text-lg leading-relaxed max-w-2xl">
            Fale hoje mesmo com nossos engenheiros especialistas de +15 anos de mercado e obtenha um diagnóstico técnico sem custo para a sua residência, fazenda ou empresa. Proteja o que é mais valioso com quem domina a tecnologia de ponta.
          </p>
